...
export const RECRUITERS_FAQ: FaqItem[] = [
  {
    ...
    answer:
      'Nothing. HireAll is an open-source, non-commercial aggregator — no fees, no paywall, no upsell, and no paid placement. A submitted role sits in the same catalogue, ranked the same way, as one crawled from a company board.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'No, list the whole board instead. If you hire through Greenhouse, Lever, Ashby, Workable or another supported ATS, HireAll can crawl every role you publish and close them when you take them down, which is less work than submitting each vacancy by hand.',
  },
];
